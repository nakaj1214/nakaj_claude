#!/usr/bin/env python3
"""
_shared/registry/skills.yaml を生成するスクリプト。

使い方:
    python _shared/meta/generate-registry.py
...
TRIGGER_MAP = {
    ...
    "css-features":               ["CSSネスト", "コンテナクエリ", ":has()", "@layer"],
    "css-layout":                 ["CSSレイアウト", "Grid", "Flexbox", "レスポンシブ"],
    "css-modern":                 ["モダンCSS", "CSS 2024"],
    "css-organization":           ["CSS設計", "BEM", "デザインシステム", "CSS変数"],
    "design-tracker":             ["設計記録", "アーキテクチャ記録", "DESIGN.md記録"],
    "executing-plans":            ["計画実行", "計画に従って"],
    "frontend-design":            ["フロントエンド設計", "UIデザイン", "コンポーネント設計"],
    "frontend-ui-ux":             ["UI/UX", "モバイルファースト", "ビジュアル階層"],
    ...
    "research-lib":               ["ライブラリ調査", "パッケージ調査"],
    "skill-creator":              ["スキル作成", "新スキル", "skill作成"],
    "simplify":                   ["リファクタ", "シンプル化", "コード整理"],
    "systematic-debugging":       ["デバッグ", "バグ", "4段階デバッグ"],
    "tdd-workflow":               ["TDD", "テスト駆動開発", "Red-Green-Refactor"],
    "test-driven-development":    ["テスト哲学", "テスト原則", "テスト設計"],
    "update-design":              ["DESIGN.md更新", "設計ドキュメント更新"],
    "update-lib-docs":            ["ライブラリドキュメント更新", "docs/libraries更新"],
    ...
    "skill-development":               ["スキル開発", "SKILL.md作成"],
