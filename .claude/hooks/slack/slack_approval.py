...
def is_internal_hook_script(command: str) -> bool:
    ...
    This prevents circular dependencies where a hook script (e.g. notify-slack.py)
    called via Bash would itself require Slack approval, blocking the notification.
    """
