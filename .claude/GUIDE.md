...
| `create-plan`     | 計画作成            | prompt.md → proposal.md → plan.md を作りたい時 | 計画書を自動作成（Codexレビューはオプション）
...
| やることリストを計画書にしたい | prompt.md に依頼を書いて `/create-plan` | prompt.md → proposal.md（構造化）→ plan.md を自動作成 |
