...
1. **SKILL.md**（概要 + description）— セッション開始時に description だけがシステムプロンプトに注入される
...
| `create-proposal` | 要件整理、proposal作成 | prompt.md から構造化された要件書を作りたい時 | prompt.md → proposal.md（品質チェック付き） |
| `create-plan` | 計画作成 | proposal.md から実装計画を作りたい時 | proposal.md → plan.md（Codexレビュー付き） |
